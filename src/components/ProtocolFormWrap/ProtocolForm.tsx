...
const ProtocolForm = ({
  ...
  const [tags, setTags] = useState(['msg', 'emoji']);
  ...
  const [relatedPros, setRelatedPros] = useState(['paylike']);

  const onAddRelatedPros = (relatedPro: string) => {
    setRelatedPros([...relatedPros, relatedPro]);
  };

  const onDeleteRelatedPros = (relatedPro: string) => {
    const remainingPros = relatedPros.filter((t) => {
      return t !== relatedPro;
    });
    setRelatedPros([...remainingPros]);
  };
    ...
    >
      <div className='flex flex-col gap-[24px] '>
        ...
        <div className='flex items-center justify-between'>
          ...
          <select
            className={cls(
              'select select-bordered select-sm w-[55%] max-w-xs',
              {
            ...
            <div className='flex flex-col gap-[8px]'>
              ...
              <div className='flex items-center self-start gap-2'>
                ...
                <div
                  ...
                  className='btn btn-xs btn-outline font-normal text-white mt-2'
                >
                  <Paperclip size={16} />
                  Add Attachment
                </div>
